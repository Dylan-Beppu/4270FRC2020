...
public class Index extends SubsystemBase {
 ...
 //   while(ISFill = false){
  ...
  public void IndexFill(){
    ...
    if(Robot.m_oi.PanIndex.get() == true && Robot.kTurret.togglebtn == false){
      //RobotMap.LeftIntake.set(-0.5);
      if(BeamBrakeTop.get() == true /*&& BeamBrakeBottom.get() == false*/ ){
        IndexBottom.set(-1);
        centerIntake.set(0.5);
    ...
    else if(Robot.m_oi.DriTargShoot.get() == true && Robot.kTurret.togglebtn == true||Robot.m_oi.PanShoot.get() == true && Robot.kTurret.togglebtn == true){
    ...
    else if(Robot.m_oi.PanOut.get() == true){
      RobotMap.CenterIntake.set(-0.5);
      IndexBottom.set(1);
      RobotMap.LeftIntake.set(0.5);

    }
    else if(Robot.m_oi.PanBleh.get() == true){
      RobotMap.CenterIntake.set(0.5);
      IndexBottom.set(-1);
      RobotMap.LeftIntake.set(-0.5);
      RobotMap.Topin.set(-1);
  ...
  public void index(){
    if(Robot.m_oi.Driver.getRawAxis(2) != 0){
      centerIntake.set(-1);
      //IndexFill(1);
    }
    else {
