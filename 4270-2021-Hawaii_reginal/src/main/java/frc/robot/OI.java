...
public class OI {
  ...
  public JoystickButton Joybtn10 = new JoystickButton(Driver, 10);
  public JoystickButton Joybtn11 = new JoystickButton(Driver, 11);
  public JoystickButton Joybtn12 = new JoystickButton(Driver, 12);
  public JoystickButton Joybtn13 = new JoystickButton(Driver, 13);
  public JoystickButton Joybtn14 = new JoystickButton(Driver, 14);
  public JoystickButton Joybtn15 = new JoystickButton(Driver, 15);
  public JoystickButton Joybtn16 = new JoystickButton(Driver, 16);
  public JoystickButton Joybtn17 = new JoystickButton(Driver, 17);
