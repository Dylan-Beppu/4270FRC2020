...
public class Index extends SubsystemBase {
  ...
  public void IndexFill(){
    ...
    if(Robot.m_oi.BtnPanle4 == true && Robot.kTurret.togglebtn == false){
      //RobotMap.LeftIntake.set(-0.5);
      if(BeamBrakeTop.get() == true && BeamBrakeBottom.get() == false ){
        IndexBottom.set(-1);
        centerIntake.set(0.5);
    ...
    else if(Robot.m_oi.R2 == true && Robot.kTurret.togglebtn == true){
    ...
    else if(Robot.m_oi.BtnPanle6 == true){
      RobotMap.CenterIntake.set(-0.5);
      IndexBottom.set(1);
      RobotMap.LeftIntake.set(0.5);

    }
    else if(Robot.m_oi.BtnPanle2 == true){
      RobotMap.CenterIntake.set(0.5);
      IndexBottom.set(-1);
      RobotMap.LeftIntake.set(-0.5);
      RobotMap.Topin.set(-1);
